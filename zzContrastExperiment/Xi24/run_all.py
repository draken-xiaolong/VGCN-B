...
# -*- coding: utf-8 -*-
"""
批量运行Xi24对比实验的所有Fig测试脚本（Fig1-Fig12）
...
class FigRunner:
    ...
    def run_all(self):
        ...
        self.log("="*80)
        self.log("开始批量运行Xi24对比实验 Fig1-Fig12测试脚本")
        self.log("="*80)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='批量运行Xi24对比实验 Fig1-Fig12测试脚本')
